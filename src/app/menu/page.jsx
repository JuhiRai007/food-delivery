                    ...
                    <div key={item.id} className='flex flex-col sm:flex-row gap-3 sm:gap-4 rounded-lg border bg-slate-800 overflow-hidden'>
                        ...
                        <div className='p-3 sm:p-4 flex-1'>
                            ...
                            <div className='flex flex-col sm:flex-row sm:justify-between sm:items-end mt-4 sm:mt-6 gap-3 sm:gap-0'>
                                ...
                                <button className='text-white px-3 py-1 sm:px-3 sm:py-1 font-bold rounded-lg bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 hover:from-amber-500 hover:via-amber-600 hover:to-amber-700 text-sm sm:text-base w-full sm:w-auto transition-all duration-300 hover:scale-105 hover:shadow-lg'>Add to Order</button>
                            </div>
                        </div>
                    </div>
                ))}
